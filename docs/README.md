...
|----------|-------------|
| [DOCUMENTATION.md](DOCUMENTATION.md) | Main project overview and architecture |
...
The [adr/](adr/) folder contains Architecture Decision Records documenting significant technical decisions:

| ADR | Title |
|-----|-------|
| [001](adr/001-multi-agent-ai-orchestration.md) | Multi-Agent AI Orchestration |
| [002](adr/002-part-image-search-strategy.md) | Part Image Search Strategy |
| [003](adr/003-smart-add-photo-attachment.md) | Smart Add Photo Attachment |
| [004](adr/004-development-guidelines-core-functionality.md) | Development Guidelines & Core Functionality |
| [005](adr/005-manual-download-fallback-strategy.md) | Manual Download Fallback Strategy |
| [006](adr/006-document-management-enhancements.md) | Document Management Enhancements |
| [007](adr/007-part-image-management.md) | Part Image Management |
